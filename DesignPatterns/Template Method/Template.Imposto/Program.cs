...
Console.WriteLine($"O custo para o imposto do tipo IKCV foi de R${ikcv.Calcular(orcamento)}");
Console.WriteLine($"O custo para o imposto do tipo IHIT foi de R${ihit.Calcular(orcamento)}");
...
Console.WriteLine($"Orcamento com seis itens e valor total de R${orcamento.Valor()}");
...
Console.WriteLine($"Orcamento com oito itens, sendo dois duplicados, e valor total de R${orcamento.Valor()}");
